...
int main()
{
  ...
  LD_R_encoder::encode_Q_bundle<orthopolynomial_basis>(Qcode,Sobs,bases0,normalize_flag);
  ...
  LD_matrix Rmat(fspace0,Sobs,LD_matrix_file(name.name_matrix_file(obs_name,fam_name,"R"))); double tol_use_R = 1e-10;
