    ...
    methods (Static)
        ...
        function [plt,plt_jspc,plt_xi_spc,plt_xi_sec] = plot_LDsol_model_summary(p_,mod_,d_)
            ...
            if (mod_.isrtmags_dXi_S_sO_crv(1) ~= mod_.icrv_sO)
                pspc_i.Color = [1 1 1];
                [plt_jspc,pspc_i] = apv_plots.plot_Sobs(plt_jspc, mod_.Sobs{mod_.icrv_sO},pspc_i);
            end
            pspc_i.Color = apv_plots.blue1;
            [plt_jspc,pspc_i,leg_S_2] = apv_plots.plot_Sobs(plt_jspc, mod_.Sobs{mod_.isrtmags_dXi_S_sO_crv(1)},pspc_i);
            pspc_i.Color = apv_plots.red1;
            [plt_jspc,pspc_i,leg_S_3] = apv_plots.plot_Sobs(plt_jspc, mod_.Sobs{mod_.isrtmags_dXi_S_sO_crv(2)},pspc_i);
            pspc_ii = pspc_i;
            pspc_ii.Color = apv_plots.grey3;
            pspc_ii.LineStyle = 'none';
            [plt_jspc,~,leg_S_4] = apv_plots.plot_Sobs(plt_jspc, mod_.Smat(:,mod_.isrtmags_dXi_S_sO(1:(2*nvar_N1))),pspc_ii);
            plt = plt_jspc;
            axs = plt.axs;
            axs_mat = plt.axs_mat;
            ...
            for k = 1:(kor+1)
                ...
                for i = 1:ndep
                    ...
                    leg_S_3(ileg).DisplayName = ['$ (x , ' dkxui_str_ki ' )|_{C_{\textrm{neighbor}}} $'];
                    leg_S_4(ileg).DisplayName = ['$ (x , ' dkxui_str_ki ' )|_{ \Xi_{\textrm{neighbor}}} $'];
            ...
            t_sO = mod_.t_O;
            G0_sO_basis = mod_.GN1_s0O_basis;
            G_sNO_basis = mod_.GN1_sNO_basis;
            G_sO_basis = mod_.GN1_sO_basis;

            A_G_sO = G_sNO_basis.U * diag(G_sNO_basis.s) * G_sNO_basis.V';
            ...
            J_xi_sO = [ G_sO_basis.JXi_sO_TspcO ; zeros( ndep,nvar_N1 ) ];
            ...
            set(axs, ...
                ...
                'FontSize',16 );
            plt.show_toolbar
            % Hsvd_tvf_YHnet_S = G_sO_basis.Hsvd_tvf_YHnet_S;
            ...
            svds_i = { ...
                ...
                mod_.Gsvd_N1_opt,  '$G_{\mathrm{opt}}'; ...
                mod_.Bsvd_t0_N1,  '$B^{(0)}'; ...
                mod_.Bsvd_tdxu_N1,  '$B_{d_x u}'; ...
                mod_.Nsvd_N1_net,  '$N_{\mathrm{net}}'; ...
                mod_.Nsvd_N1_com,  '$N_{\mathrm{com}}'; ...
                mod_.Nsvd_N1_opt,  '$N_{\mathrm{opt}}'; ...
                G_sO_basis.Hsvd_LamTheta_S, '$H^{(0)}_{\mathrm{net}}'; ...
                G_sO_basis.Hsvd_tvf_YH_S, '$H^{(0)}_{\mathrm{tvf}} Y_{H^{(0)}_{\mathrm{net}}} '; ...
                G_sO_basis.Vspc_Jl_svd_S, '$ D_{ \varepsilon } \lambda '; ...
            };
            % mod_.Rsvd_N1 , '$R^1'; ...
            % mod_.Gsvd_N1,  '$G'; ...
            ...
            title(axi, ['SVDs over base/jet space (at the origin) '], ...
                'Interpreter','Latex','FontSize',12 );
            svds_i = { ...
                mod_.Gcom_sNO_basis , '$\Lambda^{(1)} |_{s_O} W_{G_c}'; ...
                mod_.Gnet_sNO_basis , '$\Lambda^{(1)} |_{s_O} W_{G_n}'; ...
                mod_.Ncom_sNO_basis , '$\Lambda^{(1)} |_{s_O} W_{G_c} D_{N_c}'; ...
                mod_.Nnet_sNO_basis , '$\Lambda^{(1)} |_{s_O} W_{G_n} D_{N_n}'; ...
                mod_.Nopt_sNO_basis , '$\Lambda^{(1)} |_{s_O} W_{G_n} D_{N_o}'; ...
                mod_.GN1_sO_basis , '$\Lambda |_{s_O} W_G'; ...
                mod_.GN1_sO_basis.sO_nTVF , '$\Lambda |_{s_O} W_{G_{nt}}'; ...
                mod_.Gcom_s0O_basis, '$\Lambda^{(0)} |_{s_O} W_{G_c}'; ...
                mod_.Gnet_s0O_basis, '$\Lambda^{(0)} |_{s_O} W_{G_n}'; ...
                mod_.SXi_sO_svd , '$ \Delta \Xi_S/ \| \Delta \Xi_S \| '; ...
                G_sO_basis.theta_svd_xicoords_TspcO, '$ \Theta^{\xi} '; ...
                G_sO_basis.JXi_svd_sO_TspcO, '$J \Xi |_{s_O}'; ...
                G_sO_basis.gEta_tvf_svd, '$ J ( \eta_{\mathrm{tvf}}^i ) '; ...
                G_sO_basis.gEta_tvf_YJl_svd, '$ J ( \eta_{\mathrm{tvf}, YJ_{\lambda} }^i ) '; ...
                G_sO_basis.gEta_tvf_Y_VJl_svd, '$ J ( \eta_{\mathrm{tvf}, YVJ_{\lambda} }^i ) '; ...
            };
            % mod_.Nnet_s0O_basis, '$\Lambda^{(0)} |_{s_O} W_{G_n} D_{N_n}'; ...
            ...
            title(axi, ['trivial vector field canonical dependent coordinates, satisfying $ \mathbf{\tau} \cdot \nabla \eta_{\textrm{tvf}} = d_{x} (\eta_{\textrm{tvf}}) = 0 $'], ...
                'Interpreter','Latex','FontSize',12 );
            nleg_i = size(G_sO_basis.Eta_tvf_S,2);
            cmat_i = cool(nleg_i);
            for i = 1:nleg_i
                % abs((G_sO_basis.Eta_tvf_S(:,i) - G_sO_basis.Eta_tvf_sO(i))./G_sO_basis.Eta_tvf_sO(i)), ...
                % abs(G_sO_basis.Eta_tvf_S(:,i) - G_sO_basis.Eta_tvf_sO(i)), ...
                % G_sO_basis.Eta_tvf_S(:,i) - G_sO_basis.Eta_tvf_sO(i), ...
                % (G_sO_basis.Eta_tvf_S(:,i) - G_sO_basis.Eta_tvf_sO(i))./G_sO_basis.Eta_tvf_sO(i), ...
                leg_i(i) = plot(axi, ...
                    mod_.Smat(1,:), ...
                    reshape( ...
                    abs(G_sO_basis.Eta_tvf_Y_VJl_S(:,i) - G_sO_basis.Eta_tvf_Y_VJl_sO(i)), ...
                    1, []), ...
                    'LineStyle', 'none', ...
                    'LineWidth', 0.5, ...
                    'Color', cmat_i(i,:), ...
                ...
                % abs(G_sO_basis.Eta_tvf_YJl_S(:,i) - G_sO_basis.Eta_tvf_YJl_sO(i)), ...
                % abs(G_sO_basis.Eta_tvf_S(:,i) - G_sO_basis.Eta_tvf_sO(i)), ...
            end
            set(axi, ...
                'XScale', 'linear' , ...
