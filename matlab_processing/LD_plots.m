classdef LD_plots
    ...
    methods (Static)
        function plt = plot_S_svds(Sarray_,plt_)
            ...
            for i = 1:nset
                leg1(i) = plot(axs(1),1:(Sarray_(i).ncol),min(Sarray_(i).smat,[],2), ...
            ...
            for i = 1:nset
                leg2(i) = plot(axs(2),1:(Sarray_(i).ncol),median(Sarray_(i).smat,2), ...
            ...
            for i = 1:nset
                leg3(i) = plot(axs(3),1:(Sarray_(i).ncol),max(Sarray_(i).smat,[],2), ...
