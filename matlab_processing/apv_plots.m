classdef apv_plots
    ...
    methods (Static)
        ...
        function [plt,plt_jspc,plt_xi_spc,plt_xi_sec] = plot_LDsol_model_summary(p_,mod_,d_)
            ...
            pspc_i = pspc;
            if (mod_.isrtmags_dXi_S_sO(1) ~= mod_.icrv_sO)
                pspc_i.Color = [1 1 1];
                [plt_jspc,pspc_i] = apv_plots.plot_Sobs(plt_jspc, mod_.Sobs{mod_.icrv_sO},pspc_i);
            end
            pspc_i.Color = apv_plots.blue1;
            [plt_jspc,pspc_i,leg_S_2] = apv_plots.plot_Sobs(plt_jspc, mod_.Sobs{mod_.isrtmags_dXi_S_sO(1)},pspc_i);
            pspc_i.Color = apv_plots.red1;
            [plt_jspc,pspc_i,leg_S_3] = apv_plots.plot_Sobs(plt_jspc, mod_.Sobs{mod_.isrtmags_dXi_S_sO(2)},pspc_i);
            plt = plt_jspc;
            axs = plt.axs;
            axs_mat = plt.axs_mat;
            ...
            for k = 1:(kor+1)
                ...
                for i = 1:ndep
                    ...
                    legend(plt_jspc.axs(ileg), [ leg_S_1(ileg) leg_S_2(ileg) leg_S_3(ileg) ],'Interpreter', 'Latex', ...
            ...
            for i = 1:ndep
                ...
                for k = 2:(kor+1)
                    ...
                    leg_ii(i,1,k) = plot2D( ...
                        axs_mat(i,k),mod_.Smat(1,:),tau_uiN(k-1,:),'none',[0 1 0],'o',ceil(0.5*pspc.MarkerSize), ...
            ...
            [plt_xi_spc,pspc_xi,leg_xi_2] = apv_plots.plot_Sobs(plt_xi_spc,Sobs_Xi{mod_.isrtmags_dXi_S_sO(1)},pspc_xi);
            pspc_xi.Color = apv_plots.red1;
            [plt_xi_spc,pspc_xi,leg_xi_3] = apv_plots.plot_Sobs(plt_xi_spc,Sobs_Xi{mod_.isrtmags_dXi_S_sO(2)},pspc_xi);
            pspc_xi.Color = [1 1 1];
            ...
            for i = 1:nvar_N1
                ...
                legend(plt_xi_spc.axs(i), [ leg_xi_1(i) leg_xi_2(i) leg_xi_3(i) leg_xi_4(i) ],'Interpreter', 'Latex', ...
                'Location', 'EastOutside', ...
            ...
            Smat_eta = [ mod_.Smat(1,:) ; G_sO_basis.Eta_tvf_S' ] - [mod_.s_O(1) ; G_sO_basis.Eta_tvf_sO'];
            ...
            svds_i = { ...
                ...
                G_sO_basis.gEta_svd_tvf, '$ J \lambda |_{s_O} \Theta^{\eta_{\textrm{tvf}}} '; ...
            };
            svds = cell([ size(svds_i,1),1 ]);
            labels = cell([length(svds),1]);
            for isvd = 1:size(svds_i,1)
