classdef LD_denoise_plots < LD_plots
    ...
    methods (Static)
        function [plts_out,dnse_data] = plot_denoising_summary(plts_,spc_,Ssets_,ode_,icrv_)
            ...
            Tsvd_Pg_0_tru = Sref.read_LD_svd( [Tsvd_g_names{1} '_full'] );
            Tsvd_g_0_tru = Sref.read_LD_svd( [Tsvd_g_names{2} '_full'] );
            ...
            Tsvd_Pg_0 = Snse.read_LD_svd( [Tsvd_g_names{1} '_full'] );
            Tsvd_g_0 = Snse.read_LD_svd( [Tsvd_g_names{2} '_full'] );
            ...
            [spc.lspec,spc.lw,spc.mspec,spc.ms,spc.color] = deal('-',2,...
                                                                '.',10, ...
                                                                [0 0 0] );
            plot_ax(axs_err, ...
                    iwrite_full, ...
            ...
            ylabel(axs_rnk, ...
                ...
                for i = 1:ndof
                    ...
                    plot(axs_theta, ...
                        1:ndof, ...
                        Tsvd_g_0_tru.V(:,i), ...
                        'Color',[spc.color, Tsvd_g_0_tru.s(i)/Tsvd_g_0_tru.s(1) ], ...
                        'Marker', spc.mspec, ...
                        'LineStyle', spc.lspec, ...
                        'MarkerSize',spc.ms,'LineWidth',spc.lw)
                    ...
                    plot(axs_theta, ...
                        1:ndof, ...
                        Tsvd_g_0.V(:,i), ...
                        'Color',[spc.color, Tsvd_g_0.s(i)/Tsvd_g_0.s(1) ], ...
                        'Marker', spc.mspec, ...
                        'LineStyle', spc.lspec, ...
                        'MarkerSize',spc.ms,'LineWidth',spc.lw)
                ...
                plot_ax(axs_ker, ...
                        1:ndof, ...
                        comp_pinv_spec_err(Tsvd_Pg_0_tru.s , Tsvd_Pg_0_tru.V), ...
                        spc);

                spc.color = LD_plots.orange1;
                plot_ax(axs_ker, ...
                        1:ndof, ...
                        comp_pinv_spec_err(Tsvd_Pg_0.s , Tsvd_Pg_0.V), ...
                        spc);
                ...
                xlabel(axs_ker, ...
                    ['$$ i_{\theta} $$'], 'Interpreter','Latex','FontSize',14);
                ylabel(axs_ker, ...
                    ['$$ \| \mathbf{R}^{(n)} \tilde{\theta}_i \|_2 $$'], 'Interpreter','Latex','FontSize',14);
            ...
            xlabel(axs_sigma, ...
                ['$$ i_{\theta} $$'], 'Interpreter','Latex','FontSize',14);
            ylabel(axs_sigma, ...
                ['$$ \sigma_{i_{\theta}} ( \mathbf{R}^{(n)} ) $$'], 'Interpreter','Latex','FontSize',14);
            ...
            set(axs_ver, ...
                ...
                'TickLabelInterpreter','Latex','FontSize',14);
            xlabel(axs_ver, ...
                ['$$ d_x \tilde{u} - \upsilon_{d_x u} (\tilde{W} |_{(x,\tilde{u})} ) $$'], 'Interpreter','Latex','FontSize',14);
            ylabel(axs_ver, ...
                ['$$ d_x u - \upsilon_{d_x u} (\tilde{W} |_{(x,\tilde{u})} ) $$'], 'Interpreter','Latex','FontSize',14);
