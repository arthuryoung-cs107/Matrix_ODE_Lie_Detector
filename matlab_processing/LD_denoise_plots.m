    ...
    methods (Static)
        function [plts_out,dnse_data] = plot_denoising_summary(plts_,spc_,Ssets_,ode_,icrv_)
            ...
            plot_ax(axs_ker, ...
                    ...
                    spc);
                    % sqrt(sum((SVT_g_0_tru * ( Rsvd_g_0_tru.s .* Rsvd_g_0_tru.V )).^2,1)), ...
            ...
            plot_ax(axs_ker, ...
                    ...
                    spc);
                    % sqrt(sum((SVT_g_0_tru * ( Rsvd_g_0.s .* Rsvd_g_0.V )).^2,1)), ...
            ...
            for i = 1:len_iwrite_plot
                ...
                plot(axs_ker, ...
                    ...
                    'LineStyle', spc.lspec, ...
                    'MarkerSize',spc.ms,'LineWidth',spc.lw)
                    % sqrt(sum( abs(SVT_g_0_tru * ( Smat(:,i)' .* Vtns(:,:,i) )) ,1)), ...
            end
            ...
            for i = 1:len_iwrite_plot
                ...
                plot(axs_ker, ...
                    1:ndof, ...
                    sqrt(sum((SVT_g_0_tru * ( Smat(:,i)' .* Vtns(:,:,i) )).^2,1)), ...
                    'Color',spc.color, ...
                    'Marker', spc.mspec, ...
                    'LineStyle', spc.lspec, ...
                    'MarkerSize',spc.ms,'LineWidth',spc.lw)
