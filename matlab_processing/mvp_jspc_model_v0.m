classdef mvp_jspc_model
    ...
    methods
        function obj = mvp_jspc_model(Sobs_,Sdat_,fdat_)
            ...
            for k = 1:kor_obs
                ...
                if (k == kor_obs)
                    ...
                    if (kor_obs==1)
                        ...
                        iiY_l = iY_l;
                        jjY_l = 1:PiY_l;
                        Y_LamdNm1xu_glb = zeros(ntheta,nvar*PiY_l);
                        for ivar = 1:nvar
                            Y_LamdNm1xu_glb(iiY_l,jjY_l) = lvs_svd.V(:,iY_l);
                            iiY_l = iiY_l + Plen;
                            jjY_l = jjY_l + PiY_l;
                        end
                    else
                        iY_LamdNm1xu = 1:(Lam_dkxu_svd_glb{kor_obs-1}.r);
                        Y_LamdNm1xu_glb = Lam_dkxu_svd_glb{kor_obs-1}.V(:,iY_LamdNm1xu);
                    end
                    RN_YLdNm1xu_glb_svd = Asvd_package((Rksvds_glb{kor_obs}.D')*Y_LamdNm1xu_glb);
                    vth_RN_YLdNm1xu_glb = comp_vartheta( ...
                        Y_LamdNm1xu_glb*RN_YLdNm1xu_glb_svd.W, lvs ...
                    );
                    tau_dNm1xu_RN_YLdNm1xu_glb = comp_tau_uk_glb(vth_RN_YLdNm1xu_glb,kor_obs,1:Plen);
                end
                for b = bor_to_one
            ...
            Yvthx_N_glb = vthx_N_glb_svd.V(:,iYvthx);
            ...
            RNsvds_crv_vthxglb = cell([1,ncrv]);
