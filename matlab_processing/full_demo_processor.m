...
SRarray(2) = LD_observations_set(dir_name,eqn_name,'true','DoP853','Chebyshev1',8,'Rmat','DoP853','ext',dat_suff);

SQarray(1) = LD_observations_set(dir_name,eqn_name,'true','DoP853','Chebyshev1',10,'Qmat','DoP853','ext',dat_suff);
SQarray(2) = LD_observations_set(dir_name,eqn_name,'true','DoP853','Chebyshev1',8,'Qmat','DoP853','ext',dat_suff);
